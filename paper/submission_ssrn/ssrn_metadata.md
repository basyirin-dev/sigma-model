...
5. [x] Open-source repository: \url{https://github.com/basyirin-dev/sigma-model} (Release \texttt{v2.0-paper02}, Commit \texttt{540c992}) and reproducibility bundle (\texttt{supplementary\_materials.zip}). A permanent Zenodo DOI will be minted concurrent with or prior to SSRN posting.
