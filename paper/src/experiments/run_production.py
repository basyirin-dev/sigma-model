...
into the canonical raw data repository: paper/data/raw/all_results.pkl.
"""
...
def ingest_gate_results(
    source_pkl_path: str | Path = "paper/experiments/2026-08-24_gate/all_results.pkl",
    target_raw_dir: str | Path = "paper/data/raw",
) -> IngestionSummary:
...
def generate_master_run_log(
    raw_pkl_path: str | Path = "paper/data/raw/all_results.pkl",
    output_log_path: str | Path = "paper/experiments/run-log.csv",
) -> pd.DataFrame:
