...
**Deliverables:** `paper/decisions/ADR-001_two_subspace_formulation.md` (formalized), updated `paper/planning/ledger.md`, `paper/src/continuous/two_subspace_ode.py` (analytical prototype)
...
- [x] `paper/decisions/ADR-001_two_subspace_formulation.md` contains the complete analytical proof of $\lambda_{\text{crit}} = b_C / a_C$.
- [x] `paper/planning/ledger.md` populated with CLM-001 through CLM-007.
- [x] Risk scoring table complete with all 4 assumptions quantified.
- [x] Prototype ODE simulation script `paper/src/continuous/two_subspace_ode.py` executes and plots theoretical bifurcation diagram.
- [ ] `[HUMAN-GATE]` Hypothesis approval signed off.

---

## 5. Deliverables & Artifacts
- Decision record: `paper/decisions/ADR-001_two_subspace_formulation.md`
- Decision record: `paper/decisions/ADR-003_hypothesis_and_observable_signatures.md`
- Prototype ODE solver: `paper/src/continuous/two_subspace_ode.py`
- Observable signatures module: `paper/src/continuous/observable_signatures.py`
- Diagnostic figures: `paper/writing/figures/two_subspace_bifurcation.png`, `paper/writing/figures/observable_signatures.png`
- Scope updates: `paper/planning/ledger.md`
