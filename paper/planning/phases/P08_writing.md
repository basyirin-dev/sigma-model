...
**Deliverables:** `paper/writing/manuscript.tex`, `paper/writing/manuscript.pdf`, `paper/writing/bibliography.bib`, `paper/decisions/ADR-008_manuscript_framing.md`
...
1. Curate verified BibTeX entries in `paper/writing/bibliography.bib`.
2. Format in official `neurips_2026.sty` / `iclr2026.sty` template.
3. Verify compilation via `make -C paper pdf` asserting 0 errors, 0 undefined citations (`[?]`), and 0 undefined references (`[??]`).
...
- [x] Manuscript compiles cleanly via `make -C paper pdf` (exit code 0).
...
- Manuscript sources: `paper/writing/manuscript.tex`, `paper/writing/bibliography.bib`
- Compiled PDF: `paper/writing/manuscript.pdf`
- Decision record: `paper/decisions/ADR-008_manuscript_framing.md`
