...
**Deliverables:** `paper/experiments/literature/survey_table.csv`, `paper/planning/literature-audit.md` (appended Gap Memo), `paper/decisions/ADR-004_literature_positioning.md`
...
**Status:** ✅ Complete (2026-08-23) — `survey_table.csv` contains 60 curated entries (12 per cluster × 5 clusters); build script `paper/experiments/literature/build_survey_table.py`.
...
2. Save to `paper/experiments/literature/survey_table.csv`.

### Task 1.3: Methodological Clustering & Comparative Positioning
**Status:** ✅ Complete (2026-08-23) — full row-cited, claim-tagged synthesis in `paper/planning/methodological-clustering.md`; condensed pointer in `paper/planning/literature-audit.md` §8. Claim-audited (skill:claim-auditor + independent review; CC.3.3 tags; CLM-001–007 ledger mapping).
...
**Status:** ✅ Complete (2026-08-23) — Gap-Analysis Memo appended as `paper/planning/literature-audit.md` §9; `paper/decisions/ADR-004_literature_positioning.md` emitted (Status: Proposed, pending `[HUMAN-GATE]` §9.6). Claim-audited + independently reviewed (verbatim proposition, P03-gate-aligned falsifiability, CC.3.3 tags).
1. Draft a 3-page rigorous Gap-Analysis Memo and append to `paper/planning/literature-audit.md`.
...
3. Emit `paper/decisions/ADR-004_literature_positioning.md`.
...
- [x] `paper/experiments/literature/survey_table.csv` contains $\ge 50$ curated entries across the 5 clusters. *(60 entries, 12 per cluster — verified 2026-08-23)*
...
- [x] `paper/decisions/ADR-004_literature_positioning.md` committed. *(Emitted 2026-08-23; committed with the Task 1.4 commit)*
- [ ] `[HUMAN-GATE]` Novelty positioning approved. *(Open — approval block at `literature-audit.md` §9.6; ADR-004 Status: Proposed)*

---

## 5. Deliverables & Artifacts
- Extraction table: `paper/experiments/literature/survey_table.csv`
- Appended memo: `paper/planning/literature-audit.md`
- Decision record: `paper/decisions/ADR-004_literature_positioning.md`
