...
**Deliverables:** OpenReview submission receipt, `paper/decisions/ADR-012_post_mortem.md`, `paper/planning/roadmap_v3_draft.md`, closed `paper/planning/ledger.md`
...
1. **Submission Steps (Executed by PI with Agent Verification):**
   - Upload camera-ready PDF and anonymized supplementary ZIP (`paper-code-data.zip`) to OpenReview.
...
2. **Log Submission Metadata:**
   - Record forum URL, paper ID, submission timestamp, and SHA-256 hash of submitted PDF in `paper/planning/submission_receipt.md`.
...
2. **Freeze Directory Permissions:**
   - Set read-only flags on `paper/data/` and `paper/writing/` to prevent post-submission drift.

### Task 12.3: Comprehensive Post-Mortem ADR
1. Write and commit `paper/decisions/ADR-012_post_mortem.md`:
...
1. Draft and commit `paper/planning/roadmap_v3_draft.md`:
...
1. Close all entries in `paper/planning/ledger.md`:
...
- [ ] `paper/planning/submission_receipt.md` exists with OpenReview forum URL and PDF hash.
- [ ] Git tag `v2.0-paper02-submitted` verified.
- [ ] `paper/decisions/ADR-012_post_mortem.md` committed.
- [ ] `paper/planning/roadmap_v3_draft.md` committed.
- [ ] `paper/planning/ledger.md` 100% closed and frozen.
- [ ] `[HUMAN-GATE]` Submission signed off.

---

## 5. Deliverables & Artifacts
- Submission receipt: `paper/planning/submission_receipt.md`
- Git release tag: `v2.0-paper02-submitted`
- Post-mortem record: `paper/decisions/ADR-012_post_mortem.md`
- Next-paper roadmap: `paper/planning/roadmap_v3_draft.md`
