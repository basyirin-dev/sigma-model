...
\begin{abstract}
This technical report is the companion to the primary manuscript ``Compositional Generalization as a Threshold Phase Transition: Why Adaptive Curricula are Unnecessary for Asymptotic Recovery''. It preserves the extended
...
The primary manuscript develops a two-variable dynamical model
