...
precise and reproducible\footnote{This submission was prepared with the
assistance of large language models used as general-purpose assistive
tools (in accordance with the TMLR LLM-use policy); the authors are
solely responsible for all content, claims, and results.}.
Agents trained to high in-distribution
