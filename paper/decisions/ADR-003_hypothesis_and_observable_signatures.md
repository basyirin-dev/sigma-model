...
### Governance Binding:
1. **Risk #1 Binding:** No downstream manuscript drafting (P08) or large-scale multi-benchmark sweep (P06) will commence until the Phase 03 Gate evaluates 450 seeds across Arms A & B and records an unambiguous **PASS** in `paper/planning/gate-result.md`.
