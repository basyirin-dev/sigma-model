"""Generator for the Turnkey 220-Run Kaggle Production Notebook:
paper/notebooks/kaggle_p06_tiered_cross_benchmark_sweep.ipynb
"""
...
def build_tiered_kaggle_notebook() -> str:
    """Construct complete JSON content for the turnkey Kaggle Phase 06 notebook."""
    cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
        ...
        },
        {
            ...
            "source": [
                ...
                "            w_gca = compute_whitened_gca(model, loss_train, loss_comp) if lambda_val > 0 else 0.001\n",
...
if __name__ == "__main__":
    out_file = Path("paper/notebooks/kaggle_p06_tiered_cross_benchmark_sweep.ipynb")
    out_file.parent.mkdir(parents=True, exist_ok=True)
    out_file.write_text(build_tiered_kaggle_notebook(), encoding="utf-8")
    print(f"✅ Generated Kaggle Tiered Production Notebook: {out_file}")
