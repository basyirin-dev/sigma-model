...
from paper.src.analysis.representation_geometry import compute_linear_cka, compute_rga_metric
from paper.src.data.hbar_dataset import generate_hbar_splits
from paper.src.experiments.run_gate import GateRunConfig, run_gate_suite, train_gate_run
    ...
    def test_gate_suite_orchestration_and_serialization(self) -> None:
        ...
        try:
            results_path = run_gate_suite(
                config_path="paper/experiments/configs/gate_protocol.yaml",
                output_dir=temp_dir,
                arm="arm_a",
                seeds=[0],
                max_steps=5,
