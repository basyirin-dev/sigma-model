...
def sigma_critical(gamma_sigma: float, r0_min: float) -> float:
    ...
    Args:
        ...
        r0_min: Minimum basic schema reproduction number
            (R_0 = rho * P_A * alpha_A / epsilon_sigma * Omega_SL).
...
def sigma_ode(
    ...
    Autocatalytic structure: sigma_A * [rho * P_A * alpha_A * (1 - gamma_sigma * sigma_A)
        - epsilon_sigma * Omega_SL].
