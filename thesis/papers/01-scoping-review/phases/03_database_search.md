...
- [ ] 3.1.2: Execute search on Web of Science — export results as RIS/BibTeX
- [ ] 3.1.3: Execute search on ACM Digital Library — export results
- [ ] 3.1.4: Execute search on IEEE Xplore — export results
- [ ] 3.1.5: Execute search on arXiv via API — export results as JSON/CSV
- [ ] 3.1.6: Execute search on PhilPapers — export results
...
- [ ] 3.2.1: Search Google Scholar (first 200 results by relevance)
...
- [ ] 3.3.1: Retrieve technical reports from DeepMind Safety, Anthropic, OpenAI, MIRI, ARC
- [ ] 3.3.2: Retrieve relevant posts from AI Alignment Forum, LessWrong, EA Forum
- [ ] 3.3.3: Retrieve workshop papers from major AI safety workshops (NeurIPS/ICML/AAAI workshops)
- [ ] 3.3.4: Record sources, retrieval dates, and any access restrictions

### Task 3.4: Citation Chaining

- [ ] 3.4.1: Perform backward citation chaining from 10-15 seminal papers identified in Phase 2
- [ ] 3.4.2: Perform forward citation chaining from 10-15 seminal papers
- [ ] 3.4.3: Record chaining paths and new papers identified
- [ ] 3.4.4: Add newly identified papers to the search results pool

### Task 3.5: Export and Archive

- [ ] 3.5.1: Convert all exports to a unified format (BibTeX or RIS)
- [ ] 3.5.2: Archive all raw exports in `research/search-results/`
- [ ] 3.5.3: Create summary table: database, date, string, hits, notes
- [ ] 3.5.4: Satisfy CC.4.1 — raw data committed to repo
- [ ] 3.5.5: Satisfy CC.4.2 — screening data structure prepared for Phase 4
