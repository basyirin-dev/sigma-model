...
## Monograph adaptation note (2026-08)

**Status**: ✅ Paper-format draft complete (revised draft, as Paper 01). Chapter adaptation
**drafted 2026-08-14** at `thesis/chapters/02-agi-safety-landscape/manuscript/chapter2.tex`
in monograph prose (report class, shared notation, natbib citations from
`thesis/bibliography.bib`). Remaining for Phase 10 completion: full PRISMA-ScR checklist
inclusion in chapter text, figure integration, and final prose pass.
