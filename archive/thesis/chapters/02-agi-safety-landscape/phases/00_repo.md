...
- [x] 0.1.1: Ensure `thesis/chapters/02-agi-safety-landscape/` exists with `phases/` and `research/` subdirectories
...
- [x] 0.2.2: Create `manuscript.tex` with section structure:
  ...
  - `\section{Discussion}`
  - `\section{Conclusion}`
- [x] 0.2.3: Verify compilation: `make pdf` from `thesis/publications/01-scoping-review/`
