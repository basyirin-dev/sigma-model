...
$\Sigma$-Model variable $v_i$ (see Table~1 in the main manuscript):
\begin{itemize}[nosep]
...
design requirements (Table~1 in the main manuscript). They represent
...
operationalisation from Table~1 of the main manuscript. It does
