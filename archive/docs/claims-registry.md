...
| C-039 | TBD | σ-trap replicates in protein domain data (H1) — ΔCG ≥ threshold | DESIGNED | pfam-base.yaml | — | — | TBD |
| C-040 | TBD | ΔCG ≥ 30pp for low-σ models on Pfam OOD splits | DESIGNED | pfam-brittle.yaml | — | — | TBD |
| C-041 | TBD | PLMs encode surface co-occurrence, not domain grammar (H2) | DESIGNED | pfam-grammar.yaml | — | — | TBD |
| C-042 | TBD | Structural OOD accuracy < lexical OOD accuracy by >10pp | DESIGNED | pfam-brittle.yaml | — | — | TBD |
| C-043 | TBD | Multiplicative model fits better than additive (H3) | DESIGNED | pfam-base.yaml | — | — | TBD |
| C-044 | TBD | PfamCG-1.0 benchmark valid against known biology | DESIGNED | pfam-benchmark.yaml | — | — | TBD |
| C-045 | — | RESERVED for claims discovered during experimentation | — | — | — | — | — |
| C-046 | — | RESERVED for claims discovered during experimentation | — | — | — | — | — |
| C-047 | — | RESERVED for claims discovered during experimentation | — | — | — | — | — |
| C-048 | — | RESERVED for claims discovered during experimentation | — | — | — | — | — |
| C-049 | — | RESERVED for claims discovered during experimentation | — | — | — | — | — |
| C-050 | — | RESERVED for claims discovered during experimentation | — | — | — | — | — |
...
## Verification
Run `grep '<!-- CLAIM:' paper/manuscript.tex paper-neurips/main.tex | sort > /tmp/anchors.txt` and compare against claim IDs above. Every anchor must have a registry entry and vice versa.
