"""Generator for the Kaggle Production Notebook: kaggle_p06_cross_benchmark_sweep.ipynb."""
...
def build_kaggle_notebook() -> str:
    """Construct JSON content for the turnkey Kaggle Phase 06 notebook."""
    cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
...
if __name__ == "__main__":
    out_file = Path("paper02/notebooks/kaggle_p06_cross_benchmark_sweep.ipynb")
    out_file.parent.mkdir(parents=True, exist_ok=True)
    out_file.write_text(build_kaggle_notebook(), encoding="utf-8")
    print(f"✅ Generated Kaggle production notebook: {out_file}")
