...
- **Governance Record:** [`ADR-007: Multi-Benchmark Experimental Matrix & Architecture Specification`](file:///home/bigbasy/Documents/sigma-model/paper02/decisions/ADR-007_multi_benchmark_experimental_matrix.md)
- **Declarative Config:** [`paper02/experiments/configs/matrix_p04.yaml`](file:///home/bigbasy/Documents/sigma-model/paper02/experiments/configs/matrix_p04.yaml)
- **Manifest Engine:** [`paper02/src/config/matrix.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/config/matrix.py) (validation, filtering, budget calculation)
- **Verification Tests:** [`paper02/tests/test_matrix.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_matrix.py) (8 unit tests, 100% pass)
...
- **Governance Record:** [`ADR-008: Diagnostic Toolchain & Analysis Engines Specification`](file:///home/bigbasy/Documents/sigma-model/paper02/decisions/ADR-008_diagnostic_toolchain_and_analysis_engines.md)
- **Geometry & Homomorphism Engine:** [`paper02/src/analysis/geometry.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/analysis/geometry.py) (Linear & RBF CKA, Homomorphism Error, Principal Subspace Angles)
- **Hessian & Curvature Engine:** [`paper02/src/analysis/hessian.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/analysis/hessian.py) (HVP Power Iteration $\lambda_{\max}(H)$, Hutchinson Trace Estimator)
- **Circuit & Attribution Engine:** [`paper02/src/analysis/circuits.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/analysis/circuits.py) (Residual Stream Decomposition, Head Specialization $S_{\text{head}}$)
- **Verification Tests:** [`test_geometry.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_geometry.py), [`test_hessian.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_hessian.py), [`test_circuits.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_circuits.py) (14 unit tests, 100% pass)

1. **Continuous Dynamics Engine:**
   - Unified stiff ODE/SDE solvers (`atol=1e-8`, `rtol=1e-8`) in `paper02/src/continuous/` simulating the two-subspace system and computing exact theoretical phase boundaries.
...
- **Governance & Datacard:** [`paper02/docs/datacards/hbar_benchmark.md`](file:///home/bigbasy/Documents/sigma-model/paper02/docs/datacards/hbar_benchmark.md) (Gebru et al. 2021)
- **Grammar & Semantics:** [`paper02/src/data/hbar/grammar.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/data/hbar/grammar.py)
- **3-Way Decoupled Generator:** [`paper02/src/data/hbar/generator.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/data/hbar/generator.py) (Split A: Recombination, Split B: Depth, Split C: Length)
- **Zero-Leakage Auditor:** [`paper02/src/data/audit_leakage.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/data/audit_leakage.py)
- **Verification Tests:** [`test_hbar_benchmark.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_hbar_benchmark.py), [`test_audit_leakage.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_audit_leakage.py) (10 unit tests, 100% pass)
...
5. **Stratified Error Taxonomy & Standardized Datasheet (Gebru et al. 2021):**
   ...
   - Formal Dataset Card emitted in `paper02/docs/datacards/hbar_benchmark.md`.
   - Standalone modular library in `paper02/src/data/hbar/` with PyTorch & JAX DataLoaders.

### Task 4.4: Statistical Power Analysis & Pre-Registered Protocol — ✅ COMPLETED
- **Governance Record:** [`ADR-009: Statistical Power Analysis & Multi-Benchmark Pre-Registered Protocol`](file:///home/bigbasy/Documents/sigma-model/paper02/decisions/ADR-009_statistical_power_and_protocol.md)
- **PI Human Gate Directive:** [`paper02/decisions/human-gates/P04_protocol_directive.md`](file:///home/bigbasy/Documents/sigma-model/paper02/decisions/human-gates/P04_protocol_directive.md)
- **Power & Diagnostic Engine:** [`paper02/src/analysis/power.py`](file:///home/bigbasy/Documents/sigma-model/paper02/src/analysis/power.py)
- **Verification Tests:** [`test_power.py`](file:///home/bigbasy/Documents/sigma-model/paper02/tests/test_power.py) (5 unit tests, 100% pass)
...
## 3. Human Gates
- [x] `[HUMAN-GATE]` Principal Investigator reviewed and signed off on the multi-benchmark matrix, toolchain selections, and zero-leakage data card in [`P04_protocol_directive.md`](file:///home/bigbasy/Documents/sigma-model/paper02/decisions/human-gates/P04_protocol_directive.md).
...
- Protocol document: `paper02/planning/phases/P04_experimental_design.md` (Resolved)
- Decision records: `ADR-007`, `ADR-008`, `ADR-009`
- Modular H-Bar package: `paper02/src/data/hbar/`
- Zero-leakage audit tool: `paper02/src/data/audit_leakage.py`
- Formal Dataset Card: `paper02/docs/datacards/hbar_benchmark.md`
- Directive: `paper02/decisions/human-gates/P04_protocol_directive.md`
