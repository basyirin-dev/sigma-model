...
**Deliverables:** `paper02/writing/supplementary/paper02-code-data.zip`, updated `paper02/meta/*`, `paper02/decisions/ADR-011_presubmission_package.md`
...
1. **Prepare Anonymized Code Bundle:**
   - Copy `paper02/src/`, `paper02/experiments/configs/`, `paper02/Makefile`, and reproduction scripts into a staging directory.
...
3. **Compress to Supplementary Archive:**
   - Create `paper02/writing/supplementary/paper02-code-data.zip` (verify size $\le 100$ MB).

### Task 11.2: Double-Blind Anonymity Compliance Audit (CC.5.2)
1. Run automated string scanner on `paper02/writing/manuscript.pdf` and `paper02-code-data.zip`:
...
1. Update `paper02/meta/README.md` with complete abstract, headline findings, and public reproduction commands.
2. Update `paper02/planning/standards.md` Deltas section recording final lessons learned and rule outcomes.
3. Emit `paper02/decisions/ADR-011_presubmission_package.md`.
...
- [ ] `paper02/writing/supplementary/paper02-code-data.zip` exists and unzips cleanly.
- [ ] Anonymization scanner reports 0 violations in PDF and code bundle.
- [ ] `paper02/meta/README.md` updated.
- [ ] `paper02/decisions/ADR-011_presubmission_package.md` committed.
- [ ] `[HUMAN-GATE]` Package approved.

---

## 5. Deliverables & Artifacts
- Supplementary bundle: `paper02/writing/supplementary/paper02-code-data.zip`
- Updated meta docs: `paper02/meta/README.md`, `paper02/meta/ENVIRONMENT.md`
- Decision record: `paper02/decisions/ADR-011_presubmission_package.md`
