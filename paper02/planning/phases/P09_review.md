...
**Deliverables:** `paper02/planning/phases/P09_review.md` (populated report), revised `paper02/writing/manuscript.tex`, `paper02/decisions/ADR-009_review_hardening.md`
...
1. Audit every rule in `paper02/planning/standards.md` applicable to P08–P09:
...
3. Emit `paper02/decisions/ADR-009_review_hardening.md`.
...
- [ ] `paper02/decisions/ADR-009_review_hardening.md` committed.
- [ ] `[HUMAN-GATE]` Revisions approved.

---

## 5. Deliverables & Artifacts
- Review report: `paper02/planning/phases/P09_review.md` (populated)
- Hardened manuscript: `paper02/writing/manuscript.tex`
- Decision record: `paper02/decisions/ADR-009_review_hardening.md`
