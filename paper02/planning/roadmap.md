...
**Status:** P00–P02 closed (under v1.0.0, migrated) · P02.5 preregistration emitted · **P03 GATE in progress** (Tasks 3.1–3.2 complete; 450-run grid + evaluation pending)
**Date:** 2026-08-23 (v2.0 migration)
...
| D01 | Literature survey & gap memo | `paper02/planning/literature-audit.md` (+§8, §9), `survey_table.csv` | P01 | `p01-survey-done` | 🔶 Tasks 1.1–1.4 done; `[HUMAN-GATE]` novelty approval pending |
...
| D02.5 | Pre-registration of gate metrics & statistical plan | `paper02/planning/preregistration.md` | P02.5 | `p02.5-preregistered` | 🔶 Emitted 2026-08-23; PI approval pending |
| **D03** | **Mechanism-Gate Result (Separatrix validation)** | `paper02/planning/gate-result.md` | **P03** | `p03-gate-*` | 🔶 **GATE** — Tasks 3.1–3.2 done; 450-run grid + evaluation pending |
| D03.1 | Sub-gate resolution (only if INCONCLUSIVE) | `paper02/planning/phases/P03.1_subgate.md` | P03.1 | `p03.1-resolved` | ⬜ Conditional template |
| D04 | Experimental protocol specification | `paper02/planning/phases/P04_experimental_design.md` | P04 | `p04-protocol` | ⬜ Pending (locked by gate) |
| D05 | Diffrax & PyTorch implementations + unit tests | `paper02/src/` | P05 | `p05-implemented` | ⬜ Pending (locked by gate) |
| D06 | High-throughput multi-seed data tensors | `paper02/data/` | P06 | `p06-data-complete` | ⬜ Pending (locked by gate) |
| D07 | Representation geometry & Hessian diagnostics | `paper02/writing/figures/` | P07 | `p07-analysis-done` | ⬜ Pending (locked by gate) |
| D08 | Complete manuscript draft (NeurIPS/ICLR format) | `paper02/writing/manuscript.tex` | P08 | `p08-draft-v1` | ⬜ Pending (locked by gate) |
| D09 | Red-team review report & compliance audit | `paper02/planning/phases/P09_review.md` | P09 | `p09-reviewed` | ⬜ Pending |
| D09.5 | Co-author reconciliation (conditional) | `paper02/planning/phases/P09.5_coauthor.md` | P09.5 | `p09.5-reconciled` | ⬜ Conditional template |
| D10 | Independent verification report | `paper02/planning/verification-report.md` | P10 | `p10-verified` | ⬜ Pending |
| D11 | Pre-submission packaging & supplementary zip | `paper02/writing/supplementary/` | P11 | `p11-packaged` | ⬜ Pending |
| D11.5 | Preprint / press package (conditional) | `paper02/planning/phases/P11.5_preprint.md` | P11.5 | `p11.5-preprint` | ⬜ Conditional template |
| D12 | Submission receipt & Paper 03 seeding | `paper02/planning/roadmap_v3_draft.md` | P12 | `p12-submitted` + `v1.0-submitted` | ⬜ Pending |
| D13 | Revision loop (conditional) | `paper02/planning/phases/P13_revision.md` | P13 | `p13-revision-N` | ⬜ Conditional template |
| D14 | Post-publication monitoring (ongoing) | `paper02/planning/phases/P14_postpub.md` | P14 | — | ⬜ Template |
