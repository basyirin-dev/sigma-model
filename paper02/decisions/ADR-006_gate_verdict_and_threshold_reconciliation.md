...
- **Prerequisite Artifacts:**
  - `paper02/planning/preregistration.md` (P02.5 pre-registered decision criteria)
  - `paper02/experiments/2026-08-24_gate/all_results.pkl` (450-run full empirical dataset)
  - `paper02/planning/gate-result.md` (Emitted gate evaluation)
