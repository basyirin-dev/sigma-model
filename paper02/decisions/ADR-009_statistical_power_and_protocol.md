...
- **Prerequisites:**
  ...
  - `paper02/docs/datacards/hbar_benchmark.md`
...
- All statistical pipelines are implemented in `paper02/src/analysis/power.py` and validated via automated unit tests.
