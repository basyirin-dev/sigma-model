...
The full 450-run experimental matrix has been executed on Tesla T4 GPU hardware and ingested into the repository (`paper02/experiments/2026-08-24_gate/all_results.pkl`).
