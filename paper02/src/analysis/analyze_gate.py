...
def fit_logistic_separatrix(
    ...
    try:
        # Initial guesses: k = 20.0, lambda_crit = median of lambda_vals
...
def emit_gate_result_markdown(
    ...
    output_path: Path = Path("paper02/planning/gate-result.md"),
) -> None:
...
**Source Results:** `paper02/experiments/`
...
def plot_gate_diagnostics(
    ...
    output_figure_path: Path = Path("paper02/writing/figures/gate_separatrix_results.png"),
) -> None:
...
def main() -> None:
    ...
    parser.add_argument(
        "--results",
        type=str,
        default="paper02/experiments/2026-08-23_gate/all_results.pkl",
        help="Path to all_results.pkl bundle",
    )
    parser.add_argument(
        "--output-md",
        type=str,
        default="paper02/planning/gate-result.md",
        help="Path to emit gate-result.md",
    )
    parser.add_argument(
        "--output-fig",
        type=str,
        default="paper02/writing/figures/gate_separatrix_results.png",
