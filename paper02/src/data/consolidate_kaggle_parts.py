...
Merges them into canonical raw dataset: paper02/data/raw/p06_production_results.pkl
and updates paper02/experiments/run-log.csv.
"""
...
def consolidate_kaggle_results(
    raw_dir: Path | str = "paper02/data/raw",
    output_dir: Path | str = "paper02/data/raw",
    run_log_path: Path | str = "paper02/experiments/run-log.csv",
