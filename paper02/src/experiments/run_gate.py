...
from paper02.src.analysis.representation_geometry import compute_rga_metric
...
def run_gate_suite(
    config_path: str | Path = "paper02/experiments/configs/gate_protocol.yaml",
    ...
    if output_dir is None:
        ...
        output_dir = Path(f"paper02/experiments/{today_str}_gate")
    else:
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="paper02/experiments/configs/gate_protocol.yaml",
